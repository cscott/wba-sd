...
static const struct poptOption tty_options[] = {
    ...
    {"use_magenta", 0, POPT_ARG_NONE | POPT_ARGFLAG_ONEDASH, NULL, 0,
     "use magenta instead of red in all modes", NULL },
    {"use_cyan", 0, POPT_ARG_NONE | POPT_ARGFLAG_ONEDASH, NULL, 0,
     "use cyan instead of blue in all modes", NULL },
